...
@implementation SDWebImageDecoderOld
static SDWebImageDecoderOld *sharedInstance;
...
+ (SDWebImageDecoderOld *)sharedImageDecoder {
    if (!sharedInstance) {
        sharedInstance = [[SDWebImageDecoderOld alloc] init];
    }
...
+ (UIImage *)decodedImageWithImage:(UIImage *)image {
    ...
    BOOL imageHasAlphaInfo = (alphaInfo != kCGImageAlphaNone && alphaInfo != kCGImageAlphaNoneSkipFirst && alphaInfo != kCGImageAlphaNoneSkipLast);
