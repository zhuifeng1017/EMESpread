...
/**
 * SDImageCacheOld maintains a memory cache and an optional disk cache. Disk cache write operations are performed
 * asynchronous so it doesn’t add unnecessary latency to the UI.
 */
@interface SDImageCacheOld : NSObject {
    NSCache *memCache;
 ...
 *
 * @return SDImageCacheOld global instance
 */
