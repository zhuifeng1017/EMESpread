...
static SDImageCacheOld *instance;

static NSInteger cacheMaxCacheAge = 30 * 24 * 60 * 60; // one month

@implementation SDImageCacheOld
...
+ (SDImageCacheOld *)sharedImageCache {
    if (instance == nil) {
        instance = [[SDImageCacheOld alloc] init];
    }
...
#pragma mark SDImageCacheOld (private)
